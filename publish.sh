...
echo "  2. Publish NuGet tool to nuget.org"
echo "  3. Create GitHub Release with all platform binaries"
echo ""
echo "Watch progress at:"
echo "  https://github.com/nickprotop/lazydotide/actions"
echo ""
echo "Release will be available at:"
echo "  https://github.com/nickprotop/lazydotide/releases/tag/$NEW_TAG"
